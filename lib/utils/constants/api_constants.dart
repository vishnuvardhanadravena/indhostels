class ApiConstants {
  ...
  static String user(String path) => "$baseUrl/auth/user/$path";
  static String auth(String path) => "$baseUrl/auth/$path";
  ...
  /// ───────────────── AUTH ─────────────────
  static String get signin => user("signin");
  static String get signup => user("signup");
  static String get verify => user("verify");
  static String get forgotPassword => user("password/forget");
  static String get changePassword => user("password/change");
  static String get logout => user("logout");
  static String get deactivate => user("deactivateaccount");

  /// ───────────────── PROFILE ─────────────────
  static String get loadProfile => user("me");
  static String get updateProfile => user("update");
  static String get updateProfilePic => user("profilepic");
  ...
  static String get getCoupons => auth("coupon/all");

  /// ───────────────── WISHLIST ─────────────────
  static String get addToWishlist => user("wishlist");
  static String get deleteFromWishlist => user("deletewishlist");
  static String get fetchWishlist => user("getwishlist");
  ...
  static String get contactUsQuery => user("query");
}
